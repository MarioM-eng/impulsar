...
<div>
    <section wire:ignore.self data-aos="fade" data-aos-duration="1000" data-aos-delay="50" id="about-us" class="clean-block user">
        <div>
                    ...
                    <div class="col-xl-12 col-xxl-9">
                        <div class="card shadow" id="card">
                            <div class="card-header d-flex flex-wrap justify-content-center align-items-center justify-content-sm-between gap-3">
                                <h5 class="display-6 text-nowrap text-capitalize mb-0">{{$this->title}}</h5>
                                <div class="d-flex flex-row justify-content-between" style="width: 270px;">
                                    <button class="btn btn-primary btn-sm add" data-bs-toggle="modal" data-bs-target="#form" title="Agregar" wire:click="create()" type="button"><i class="fa fa-plus"></i></button>
                                    <button class="btn {{$this->paperBin['btn']}} btn-sm" id="paper-bin" title="{{$this->paperBin['title']}}" wire:click="paperBin()" type="button"><i class="fa {{$this->paperBin['icon']}}"></i></button>
                                    <div class="input-group input-group-sm w-auto px-1">
                                        <input class="form-control form-control-sm" type="search" wire:model.debounce.500ms="search" placeholder="Buscar" title="Buscar">
                                    </div>
                                </div>
                            </div>
