                ...
                <div class="col-xl-10 col-xxl-9">
                    <div class="card shadow">
                        <div class="card-header d-flex flex-wrap justify-content-center align-items-center justify-content-sm-between gap-3">
                            <h5 class="display-6 text-nowrap text-capitalize mb-0">Galería</h5>
                            <div class="d-flex flex-row justify-content-between" style="width: 255.4px;">
                                <button class="btn btn-primary btn-sm add" data-bs-toggle="modal" data-bs-target="#form" wire:click="create()" type="button"><i class="fa fa-plus"></i></button>
                            </div>
                        </div>
                        <div class="card-body">
